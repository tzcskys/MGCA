...
def cli_main():
    ...
    if args.base_model == "vit":
        ...
        # fc is not used in the segmentation, see in smp.Unet encoder
        params["fc.bias"] = None
    ...
    ckpt_dir = os.path.join(
        BASE_DIR, f"../../../data/ckpts/medclip_segmentation/{extension}")
    ...
    wandb_logger = WandbLogger(
        project="medclip_segmentation", save_dir=logger_dir,
