...
# CUDA_VISIBLE_DEVICES=0 python mgca_segmenter.py --gpus 1 --data_pct 0.01 --dataset tbx11k --batch_size 16 --learning_rate 5e-4
CUDA_VISIBLE_DEVICES=0 python mgca_segmenter.py --gpus 1 --data_pct 0.1 --dataset tbx11k --batch_size 16 --learning_rate 5e-4
CUDA_VISIBLE_DEVICES=0 python mgca_segmenter.py --gpus 1 --data_pct 1 --dataset tbx11k --batch_size 16 --learning_rate 5e-4