...
from mgca.models.backbones.detector_backbone import VitDetector
...
def cli_main():
    ...
    ckpt_dir = os.path.join(
        BASE_DIR, f"../../../data/ckpts/gloria_detection/{extension}")
    ...
    wandb_logger = WandbLogger(
        project="gloria_detection", save_dir=logger_dir,
